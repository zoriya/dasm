...
const instruction_t instructions[] = {
	...
	{.opcode = 0x0C, .extended = -1, .name = "or al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x0D, .extended = -1, .name = "or ax", .mode = {IMM16, END}, .exec = NULL},
	{.opcode = 0x0E, .extended = -1, .name = "push cs", .mode = {END}, .exec = NULL},
	...
	{.opcode = 0x14, .extended = -1, .name = "adc al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x15, .extended = -1, .name = "adc ax", .mode = {IMM16, END}, .exec = NULL},
	{.opcode = 0x16, .extended = -1, .name = "push ss", .mode = {END}, .exec = NULL},
	...
	{.opcode = 0x1C, .extended = -1, .name = "sbb al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x1D, .extended = -1, .name = "sbb ax", .mode = {IMM16, END}, .exec = NULL},
	{.opcode = 0x1E, .extended = -1, .name = "push ds", .mode = {END}, .exec = NULL},
	...
	{.opcode = 0x24, .extended = -1, .name = "and al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x25, .extended = -1, .name = "and ax", .mode = {IMM16, END}, .exec = NULL},

	{.opcode = 0x27, .extended = -1, .name = "daa", .mode = {END}, .exec = NULL},
	{.opcode = 0x28, .extended = -1, .name = "sub", .mode = {R_M8, REG8, END}, .exec = NULL},
	{.opcode = 0x29, .extended = -1, .name = "sub", .mode = {R_M16, REG16, END}, .exec = NULL},
	{.opcode = 0x2A, .extended = -1, .name = "sub", .mode = {REG8, R_M8, END}, .exec = NULL},
	{.opcode = 0x2B, .extended = -1, .name = "sub", .mode = {REG16, R_M16, END}, .exec = NULL},
	{.opcode = 0x2C, .extended = -1, .name = "sub al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x2D, .extended = -1, .name = "sub ax", .mode = {IMM16, END}, .exec = NULL},
	...
	{.opcode = 0x34, .extended = -1, .name = "xor al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x35, .extended = -1, .name = "xor ax", .mode = {IMM16, END}, .exec = NULL},
	...
	{.opcode = 0x3C, .extended = -1, .name = "cmp al", .mode = {IMM8, END}, .exec = NULL},
	{.opcode = 0x3D, .extended = -1, .name = "cmp ax", .mode = {IMM16, END}, .exec = NULL},

	{.opcode = 0x3F, .extended = -1, .name = "ass", .mode = {END}, .exec = NULL},
	{.opcode = 0x40, .extended = -1, .name = "inc ax", .mode = {END}, .exec = NULL},
	{.opcode = 0x41, .extended = -1, .name = "inc cx", .mode = {END}, .exec = NULL},
	{.opcode = 0x42, .extended = -1, .name = "inc dx", .mode = {END}, .exec = NULL},
	{.opcode = 0x43, .extended = -1, .name = "inc bx", .mode = {END}, .exec = NULL},
	{.opcode = 0x44, .extended = -1, .name = "inc sp", .mode = {END}, .exec = NULL},
	{.opcode = 0x45, .extended = -1, .name = "inc bp", .mode = {END}, .exec = NULL},
	{.opcode = 0x46, .extended = -1, .name = "inc si", .mode = {END}, .exec = NULL},
	{.opcode = 0x47, .extended = -1, .name = "inc di", .mode = {END}, .exec = NULL},
	{.opcode = 0x48, .extended = -1, .name = "dec ax", .mode = {END}, .exec = NULL},
	{.opcode = 0x49, .extended = -1, .name = "dec cx", .mode = {END}, .exec = NULL},
	{.opcode = 0x4A, .extended = -1, .name = "dec dx", .mode = {END}, .exec = NULL},
	{.opcode = 0x4B, .extended = -1, .name = "dec bx", .mode = {END}, .exec = NULL},
	{.opcode = 0x4C, .extended = -1, .name = "dec sp", .mode = {END}, .exec = NULL},
	{.opcode = 0x4D, .extended = -1, .name = "dec bp", .mode = {END}, .exec = NULL},
	{.opcode = 0x4E, .extended = -1, .name = "dec si", .mode = {END}, .exec = NULL},
	{.opcode = 0x4F, .extended = -1, .name = "dec di", .mode = {END}, .exec = NULL},
	{.opcode = 0x50, .extended = -1, .name = "push ax", .mode = {END}, .exec = NULL},
	{.opcode = 0x51, .extended = -1, .name = "push cx", .mode = {END}, .exec = NULL},
	{.opcode = 0x52, .extended = -1, .name = "push dx", .mode = {END}, .exec = NULL},
	{.opcode = 0x53, .extended = -1, .name = "push bx", .mode = {END}, .exec = NULL},
	{.opcode = 0x54, .extended = -1, .name = "push sp", .mode = {END}, .exec = NULL},
	{.opcode = 0x55, .extended = -1, .name = "push bp", .mode = {END}, .exec = NULL},
	{.opcode = 0x56, .extended = -1, .name = "push si", .mode = {END}, .exec = NULL},
	{.opcode = 0x57, .extended = -1, .name = "push di", .mode = {END}, .exec = NULL},
	{.opcode = 0x58, .extended = -1, .name = "pop ax", .mode = {END}, .exec = NULL},
	{.opcode = 0x59, .extended = -1, .name = "pop cx", .mode = {END}, .exec = NULL},
	{.opcode = 0x5A, .extended = -1, .name = "pop dx", .mode = {END}, .exec = NULL},
	{.opcode = 0x5B, .extended = -1, .name = "pop bx", .mode = {END}, .exec = NULL},
	{.opcode = 0x5C, .extended = -1, .name = "pop sp", .mode = {END}, .exec = NULL},
	{.opcode = 0x5D, .extended = -1, .name = "pop bp", .mode = {END}, .exec = NULL},
	{.opcode = 0x5E, .extended = -1, .name = "pop si", .mode = {END}, .exec = NULL},
	{.opcode = 0x5F, .extended = -1, .name = "pop di", .mode = {END}, .exec = NULL},
	...
	// {.opcode = 0x9A, .extended = -1, .name = "call", .mode = {CALL_INTER, END}, .exec = NULL},
	{.opcode = 0x9B, .extended = -1, .name = "wait", .mode = {END}, .exec = NULL},
	{.opcode = 0x9C, .extended = -1, .name = "pushf", .mode = {END}, .exec = NULL},
	...
	{.opcode = 0xE8, .extended = -1, .name = "call", .mode = {REL16, END}, .exec = NULL},
	{.opcode = 0xE9, .extended = -1, .name = "jmp", .mode = {REL16, END}, .exec = NULL},
	// {.opcode = 0xEA, .extended = -1, .name = "jmp", .mode = {CALL_INTER, END}, .exec = NULL},
	{.opcode = 0xEB, .extended = -1, .name = "jmp short", .mode = {REL8, END}, .exec = NULL},
...
const instruction_t extended[][8] = {
	// 0x80 extended
	{
		...
		{.opcode = 0x05, .extended = -2, .name = "sub", .mode = {R_M8, IMM8, END}, .exec = NULL},
	...
	// 0x81 extended
	{
		...
		{.opcode = 0x05, .extended = -2, .name = "sub", .mode = {R_M16, IMM16, END}, .exec = NULL},
	...
	// 0x83 extended
	{
		...
		{.opcode = 0x05, .extended = -2, .name = "sub", .mode = {R_M16, IMM8, END}, .exec = NULL},
	...
	// 0xff extended
	{
		...
		{.opcode = 0x02, .extended = -2, .name = "call", .mode = {R_M16, END}, .exec = NULL},
		{.opcode = 0x03, .extended = -2, .name = "call", .mode = {R_M16, END}, .exec = NULL},
		{.opcode = 0x04, .extended = -2, .name = "jmp", .mode = {R_M16, END}, .exec = NULL},
		{.opcode = 0x05, .extended = -2, .name = "jmp", .mode = {R_M16, END}, .exec = NULL},
		{.opcode = 0x06, .extended = -2, .name = "push", .mode = {R_M16, END}, .exec = NULL},
		/**/{.opcode = 0x07, .extended = -2, .name = "invalid", .mode = {END}, .exec = NULL},
	},
