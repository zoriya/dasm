...
const instruction_t instructions[] = {
	...
	{.opcode = 0x2C, .extended = -1, .name = "sub", .mode = {OPREG8, IMM8, END}, .exec = NULL},
	{.opcode = 0x2D, .extended = -1, .name = "sub", .mode = {OPREG16, IMM16, END}, .exec = NULL},
	...
	{.opcode = 0x50, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x51, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x52, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x53, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x54, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x55, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x56, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
	{.opcode = 0x57, .extended = -1, .name = "push", .mode = {OPREG16, END}, .exec = NULL},
